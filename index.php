					...
					<form method="POST" action="index.php">
						<div class="col-lg-6 col-md-6">
							<div class="input-group input-group-lg wow fadeInUp" data-wow-delay="0.8s">
								...
								<input type="text" class="form-control"  aria-describedby="sizing-addon1" name="firstname" id="firstname" placeholder="Firstname">
							</div>
							<div class="input-group input-group-lg wow fadeInUp" data-wow-delay="1.2s">
								...
								<input type="text" class="form-control"  aria-describedby="sizing-addon1" name="email" id="email" placeholder="Email">
							</div>
							<div class="input-group input-group-lg wow fadeInUp" data-wow-delay="1.6s">
								...
								<input type="text" class="form-control"  aria-describedby="sizing-addon1" name="phone" id="phone" placeholder="Phone number">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="2.0s">
							<div class="input-group">
								<textarea name="message" id="message" cols="80" rows="6" class="form-control" style="resize:none;" placeholder="Write your message..."></textarea>
							</div>
							
							<input type="button" name="submit" id="submit" class="btn btn-lg" value="Send Message"/>
						</div>
					</form>
				</div>
			</div>
...
<script type="text/javascript" src="js/contacts.js"></script>
		<div class="modal fade" tabindex ="-1" id="contactModal" data-keyboard="false" data-backdrop="static">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<i style="color:#f00;" class="fa fa-exclamation-circle fa-2x" aria-hidden="true"></i>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span arial-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">
						<h4 style="color:#f00;" class="our-logo text-center">Please, fill all the fields</h4>
					</div>
				</div>
			</div>
		</div>
		<div class="modal fade" tabindex ="-1" id="emailModal" data-keyboard="false" data-backdrop="static">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<i style="color:#f00;" class="fa fa-exclamation-circle fa-2x" aria-hidden="true"></i>
					...
					<div class="modal-body">
						<h4 style="color:#f00;" class="our-logo text-center">Please, check your Email!</h4>
					</div>
				</div>
			</div>
		</div>
		<div class="modal fade" tabindex ="-1" id="phoneModal" data-keyboard="false" data-backdrop="static">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<i style="color:#f00;" class="fa fa-exclamation-circle fa-2x" aria-hidden="true"></i>
					...
					<div class="modal-body">
						<h4 style="color:#f00;" class="our-logo text-center">Please, check your phone number!</h4>
					</div>
				</div>
			</div>
		</div>
		<div class="modal fade" tabindex ="-1" id="statuso" data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<h4 style="color:green;" class="our-logo text-center"><p id="status"></p></h4>
				</div>
			</div>
		</div>
	</div>
